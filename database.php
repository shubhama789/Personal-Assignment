...
$query = "SELECT  selectoption1.Roll,selectoption1.assignment1,selectoption1.assignment2,selectoption1.assignment3,selectoption1.assignment4,selectoption1.assignment5,selectoption1.assignment6 FROM selectoption1";
$result = $conn->query($query);
