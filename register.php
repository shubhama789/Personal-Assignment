...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form"))
       {
  $insertSQL = sprintf("INSERT INTO selectoption1 (name, email, password, confirm_password, phone_number) VALUES (%s, %s, %s, %s, %s)",
...
$totalRows_register = mysql_num_rows($register);mysql_select_db($database_MyConnection2, $MyConnection2);
$query_register = "SELECT * FROM super";
