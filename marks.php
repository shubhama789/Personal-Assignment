...
$query_marks = "SELECT * FROM assignment";
$marks = mysql_query($query_marks, $MyConnection2) or die(mysql_error());
$row_marks = mysql_fetch_assoc($marks);
$totalRows_marks = mysql_num_rows($marks);
?>
...
Total assignments : <?php echo $totalRows_marks ?>
<table border="1">
  <tr>
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $row_marks['assignmentname']; ?></td>
      <td><?php echo $row_marks['initialdate']; ?></td>
      <td><?php echo $row_marks['finaldate']; ?></td>
      <td><?php echo $row_marks['grade']; ?></td>
    </tr>
    <?php } while ($row_marks = mysql_fetch_assoc($marks)); ?>
</table>
